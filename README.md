...
- 🔭 Currently working on a stealth project — [COMPAS3 AI](https://www.compas3.ai/)
- 🤖 Building AI Agents for [Acacia Venture Capital Partners](https://www.acaciainvest.com/)
- 🌱 Learning Next.js with TypeScript to bootstrap solo without UX/UI or frontend engineers
- 🚀 Proficient in mathematical modelling + machine learning in Python
- 🔥 CFA® Charterholder (finance is my thing!)
- 🐈 Cat dad to Ash & Nacho
- ⚡ Fun fact: Jazz trumpeter-in-training, CrossFit veteran, ex-transport planner/modeller
